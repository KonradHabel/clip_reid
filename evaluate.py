...
class Configuration:
    ...
    # Checkpoint:
    checkpoint: str = "./model/ViT-L-14_openai/fold-1_seed_1/weights_e4.pth"
...
print("\nwithout re-ranking:")
mAP = compute_scores(
    dist_matrix, test_dataset.query, test_dataset.gallery, cmc_scores=True
)

if dist_matrix_rerank is not None:
    print("\nwith re-ranking:")
    mAP = compute_scores(
        dist_matrix_rerank, test_dataset.query, test_dataset.gallery, cmc_scores=True
    )
